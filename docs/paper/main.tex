...
To evaluate context efficiency, we measure the volume of historical and operational information injected into agent prompts compared to conventional conversational replay baselines.
...
\end{equation}
AgentFlow achieves a measured \textbf{85.2\%--92.1\% reduction} in active per-turn prompt overhead. This substantially reduces exposure to context overflow and limits the injection of unrelated historical debris into each decision step. We note that our current evaluation directly measures context externalization and architectural state reconstruction; controlled benchmarking of recovery success rates under live multi-agent crash injections remains an important experimental extension.
