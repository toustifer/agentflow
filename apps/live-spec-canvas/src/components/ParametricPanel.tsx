    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 700, fontSize: '13px' }}>
          <span style={{ color: 'var(--accent, #38bdf8)' }}>⚙️</span>
          <span>参数推演与分析</span>
        </div>
        <span
          style={{
      ...
      <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
            <span style={{ fontWeight: 600 }}>并发度限制 (Workers)</span>
            <span
              style={{
        ...
        >
          <div>
            <div style={{ fontWeight: 600 }}>重试容错 (Auto-Retry)</div>
            <div style={{ fontSize: '10px', color: 'var(--subtext, #a1a1aa)', marginTop: '2px' }}>
              返工 (rework) 任务自动重试恢复
            </div>
          </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span style={{ fontWeight: 700, color: '#f97316', fontSize: '13px' }}>🔥 CPM 关键路径指标</span>
            <span
              style={{
                fontSize: '10px',
                padding: '2px 6px',
          ...
          >
            <span style={{ color: 'var(--subtext, #a1a1aa)' }}>预估总工期 (Duration)</span>
          ...
          {/* Bottleneck Tasks */}
          <div>
            <div style={{ color: 'var(--subtext, #a1a1aa)', marginBottom: '4px', fontWeight: 500 }}>
              🚨 瓶颈任务 (零浮动时间节点):
            </div>
        ...
        >
          <div style={{ fontWeight: 600, marginBottom: '8px' }}>👥 工人负载分布</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
            {Object.entries(workerCounts).map(([worker, count]) => (
              ...
              >
                <span style={{ color: 'var(--subtext, #a1a1aa)' }}>{worker}</span>
                <span
                  style={{
                    background: 'var(--bg, #09090b)',
                    padding: '1px 6px',
